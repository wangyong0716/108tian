...
public class MultiPartRequest extends JsonRequest<JSONObject> {
    ...
    /* To hold the parameter name and the File to upload */
    private Map<String,byte[]> byteUploads = new HashMap<String,byte[]>();
    ...
    public void addByteUpload(String param,byte[] byteArray) {
        byteUploads.put(param,byteArray);
    }
    ...
    public Map<String,byte[]> getByteUploads() {
        return byteUploads;
    }
