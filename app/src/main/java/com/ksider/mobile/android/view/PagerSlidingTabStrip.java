...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = R.drawable.background;
	private Locale locale;

	public void setCurrentPosition(int currentPosition) {
		if (tabsContainer.getChildAt(this.currentPosition) instanceof TabIconView) {
			TabIconView currentTab = (TabIconView) tabsContainer.getChildAt(this.currentPosition);
			currentTab.settabSelected(false);
		}
	...
	public void notifyDataSetChanged() {
		...
		for (int i = 0; i < tabCount; i++) {
			if (pager.getAdapter() instanceof ITabIconViewProvider) {
				addTab(i, ((ITabIconViewProvider) pager.getAdapter()).getTabIcon(i));
		...
		getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				// "onGlobalLayout:"+pager.getCurrentItem());
	...
	protected void onDraw(Canvas canvas) {
		...
		if (tabsContainer.getChildAt(currentPosition) instanceof TabIconView) {
			TabIconView currentTab = (TabIconView) tabsContainer.getChildAt(currentPosition);
			currentTab.settabSelected(true);
		}
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
			...
			// Log.v(Constants.LOG_TAG, "onPageScrolled:"+position);
		...
		public void onPageSelected(int position) {
			// Log.v(Constants.LOG_TAG, "onPageSelected:"+position);
			setCurrentPosition(position);
			if (delegatePageListener != null) {
	...
	public void onRestoreInstanceState(Parcelable state) {
		...
		// Log.v(Constants.LOG_TAG,
		// "onRestoreInstanceState:"+savedState.currentPosition);
