 ...
 * @version 1.3.0
 */
public class OverScrollPullToRefreshListView extends BasePagingListView {

    private static final float PULL_RESISTANCE = 1.7f;
    private static final int BOUNCE_ANIMATION_DURATION = 700;
    private static final int BOUNCE_ANIMATION_DELAY = 100;
    private static final float BOUNCE_OVERSHOOT_TENSION = 1.4f;
    private static final int ROTATE_ARROW_ANIMATION_DURATION = 500;
    ...
    public OverScrollPullToRefreshListView(Context context) {
        super(context);
        init();
    }

    public OverScrollPullToRefreshListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public OverScrollPullToRefreshListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        ...
        mMaxheight = getContext().getResources().getDimension(R.dimen.header_banner_height);
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (previousY != -1 && getFirstVisiblePosition() == 0 && Math.abs(mScrollStartY - event.getY()) > IDLE_DISTANCE) {
                    ...
                    if (newHeaderPadding != headerPadding && state != State.REFRESHING && newHeaderPadding < mMaxheight) {
